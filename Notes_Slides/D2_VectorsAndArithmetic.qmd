---
title: "MAT 350: Vectors, Vector Arithmetic, and Operations"
author: Dr. Gilbert
format: 
  revealjs:
    smaller: true
...
With the vector operations defined so far, we can define a few special classes of vector that we'll encounter later in our course (but that you may have already encountered elsewhere).
...
+ given a single vector, we can multiply by an appropriate rotation matrix in order to obtain a vector normal to the original.
