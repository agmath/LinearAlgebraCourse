...
The vector equation is equivalent to the linear system

. . .

$$\left\{\begin{array}{rcr} x_1 - 3x_2 & = & -15\\ 3x_1 + 2x_2 & = & -1\\ x_1 - x_2 & = & -7\end{array}\right.$$

. . . 

Because of this, we can solve the vector equation in the same way that we solve the linear system...
...
The tools we've used to investigate and find solutions to linear systems remain directly applicable again here.
