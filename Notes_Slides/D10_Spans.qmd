...
4. Solve the matrix equation $A\vec{x} = \vec{0}$, where $A = \begin{bmatrix} 1 & 2 & 0 & 1 & -3\\ 0 & 0 & 1 & -4 & 6\\ 1 & 2 & 1 & -3 & 3 \end{bmatrix}$. Write the solution in parametric vector form and describe the solution space.
